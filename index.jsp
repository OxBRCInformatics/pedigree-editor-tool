    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
        ...
        <!--[if IE]>
        <link href="css/colibri-ie-all.css?skin=PhenoTips.Skin&#38;colorTheme=xwiki%3AColorThemes.Blue" rel="stylesheet" type="text/css" />
        <![endif]-->

       <%
            Long time = System.currentTimeMillis();

            String[] cssFiles = {"xwiki-min", "searchSuggest","exportData", "editor", "PlaygroundStyle", "Skin", "CommentsFix", "Blue", "Widgets", "PhenoTipsGroupSheet", "ContentTopMenu", "PushPatient", "DateTimePicker"};
            for(String cssFile : cssFiles){
              out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/"+cssFile+".css?"+time+"\">");
            }
            ...
            String[] jsDeferFiles = {"config", "effects", "DateTimePicker", "datepicker", "searchSuggest", "lock", "livevalidation_prototype", "fullScreen", "slider", "dragdrop", "raphael", "helpers", "queues", "baseGraph", "xcoordclass", "ordering", "import", "export", "edgeOptimization", "ageCalc", "positionedGraph", "dynamicGraph", "Blob", "FileSaver", "nodeMenu", "nodetypeSelectionBubble", "graphicHelpers", "legend", "disorder", "disorderLegend", "hpoTerm", "hpoLegend", "geneLegend", "unRenderedLegendSuper", "unRenderedLegend", "saveLoadIndicator", "templateSelector", "okCancelDialogue", "importSelector", "exportSelector", "abstractHoverbox", "readonlyHoverbox", "partnershipHoverbox", "personHoverbox", "abstractNode", "abstractNodeVisuals", "abstractPerson", "Settings", "undoRedoManager", "controller", "preferencesManager", "probandDataLoader", "saveLoadEngine", "versionUpdater", "lineSet", "childlessBehavior", "childlessBehaviorVisuals", "partnershipVisuals", "partnership", "abstractPersonVisuals", "personVisuals", "person", "personGroupHoverbox", "personGroupVisuals", "personGroup", "personPlaceholderVisuals", "personPlaceholder", "view", "svgWrapper", "workspace", "cancersLegend", "printEngine", "printDialog", "pedigree", "actionButtons","ContentTopMenu", "PushPatient", "compatibility", "markerScript","pedigreeDate", "pedigreeEditorParameters", "Widgets-new"};
